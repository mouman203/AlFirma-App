...
class _ServiceDetailsPageState extends State<ServiceDetailsPage> {
  ...
  Future<void> signaler(String categoryId, String selectedOption) async {
    try {
      ...
      final target = serviceSnapshot.get('ownerId');
    ...
    return GestureDetector(
        ...
        child: Scaffold(
            ...
            body: ListView(padding: const EdgeInsets.all(16), children: [
              ...
              _buildserviceImageGallery(isDarkMode, colorScheme),

              const SizedBox(height: 16),

              // service Info Card
              _buildserviceInfoCard(isDarkMode, theme),
  ...
  Widget _buildserviceImageGallery(bool isDarkMode, ColorScheme colorScheme) {
    return Container(
      height: 280,
      width: double.infinity,
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: NetworkImage(widget.service.photos![index]),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
  ...
  Widget _buildserviceInfoCard(bool isDarkMode, ThemeData theme) {
    return Container(
      decoration: BoxDecoration(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        ...
                        text: widget.service.description!.length > 100
                            ? (showMore
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => UserProfilePage(
                          userId: widget.service.ownerId!.trim()),
                    ),
                  );
                },
                child: CircleAvatar(
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      timeago.format(
                        widget.service.date_of_add!.toLocal(),
